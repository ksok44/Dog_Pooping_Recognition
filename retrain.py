...
def run_app():
  tmp_Dir = 'G:/My Drive/Analytic Apps/DApps_Project/tmp'
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default=os.path.join(tmp_Dir, 'output_graph.pb'),
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default=os.path.join(tmp_Dir, 'intermediate_graph'),
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default=os.path.join(tmp_Dir, 'output_labels.txt'),
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default=os.path.join(tmp_Dir, 'retrain_logs'),
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default=os.path.join(tmp_Dir, 'bottleneck'),
  ...
  parser.add_argument(
      '--checkpoint_path',
      type=str,
      default=os.path.join(tmp_Dir, '_retrain_checkpoint'),
